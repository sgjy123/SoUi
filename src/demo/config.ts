    ...
    components: [
      ...
      },
      {
        ...
        items: [
          ...
          { key: 'form-instance', label: 'Form 实例方法', componentPath: 'Form', exampleName: 'FormInstanceDemo', description: '演示 useForm 所有实例方法：setFieldsValue、getFieldsValue、validateFields、resetFields 等。' },
          { key: 'form-size', label: 'Form 尺寸', componentPath: 'Form', exampleName: 'Size', description: '小、中、大三种表单尺寸。' },
          { key: 'form-disabled', label: 'Form 禁用', componentPath: 'Form', exampleName: 'Disabled', description: '通过 disabled 属性一键禁用所有表单字段。' },
          { key: 'form-required-mark', label: 'Form 必填标记', componentPath: 'Form', exampleName: 'RequiredMark', description: '三种必填标记模式：星号、隐藏、optional 文字。' },
          { key: 'form-advanced-layout', label: 'Form 高级布局', componentPath: 'Form', exampleName: 'AdvancedLayout', description: '自定义 labelCol/wrapperCol 比例和标签对齐方式。' },
          { key: 'form-dependencies', label: 'Form 字段联动', componentPath: 'Form', exampleName: 'Dependencies', description: '密码确认、条件字段、onValuesChange 等联动场景。' },
          { key: 'form-async-validation', label: 'Form 异步校验', componentPath: 'Form', exampleName: 'AsyncValidation', description: '异步校验器模拟服务端验证（用户名/邮箱是否已注册）。' },
          { key: 'form-custom-control', label: 'Form 自定义控件', componentPath: 'Form', exampleName: 'CustomControl', description: '集成 Select、InputNumber、Switch、Rate、Slider 等多种表单控件。' },
        ],
      },
    ],
  },
