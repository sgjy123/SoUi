    ...
    components: [
      ...
      },
      {
        ...
        items: [
          ...
          { key: 'transfer-empty', label: 'Transfer 空状态', componentPath: 'Transfer', exampleName: 'Empty', description: '数据源为空时的空状态展示。' },
        ],
      },
      {
        key: 'slider',
        ...
        items: [
          ...
          { key: 'slider-marks', label: 'Slider 刻度标记', componentPath: 'Slider', exampleName: 'Marks', description: '带刻度标记和刻度点。' },
          { key: 'slider-vertical', label: 'Slider 垂直模式', componentPath: 'Slider', exampleName: 'Vertical', description: '垂直方向的滑块。' },
          { key: 'slider-tooltip', label: 'Slider 提示气泡', componentPath: 'Slider', exampleName: 'Tooltip', description: '自定义滑块提示气泡内容。' },
          { key: 'slider-reverse', label: 'Slider 反向坐标轴', componentPath: 'Slider', exampleName: 'Reverse', description: '反转坐标轴方向。' },
          { key: 'slider-event', label: 'Slider 事件回调', componentPath: 'Slider', exampleName: 'Event', description: 'onChange 与 onChangeComplete 回调。' },
