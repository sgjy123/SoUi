// Basic 示例
export const basicCode = `<div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
...
// Status 示例
export const statusCode = `<div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
...
// PrefixSuffix 示例
export const prefixSuffixCode = `<div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
...
// Addon 示例
export const addonCode = `<div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
...
// Count 示例
export const countCode = `<div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
  <Input 
    placeholder="请输入密码" 
    type="password"
    showCount
...
// Bordered 示例
export const borderedCode = `<div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
  <Input 
    placeholder="无边框模式"
    bordered={false}
  />
...
// Search 示例
export const searchCode = `<div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
  <Input 
    placeholder="搜索框"
    prefix="🔍"
    allowClear
...
// TextArea 示例
export const textAreaCode = `<div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
